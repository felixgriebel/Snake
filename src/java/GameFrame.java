    ...
    public void checkforEnd() throws InterruptedException {
        for (int i = 0; i < tail.size(); i++) {
            ...
            if (direction == 0 || direction == 1) {
                if (innerPanel.getLocation().x > tail.get(i).getLocation().x
                        && innerPanel.getLocation().y > tail.get(i).getLocation().y
                        && innerPanel.getLocation().x < (tail.get(i).getLocation().x + BODY_SIZE)
                        && innerPanel.getLocation().y < (tail.get(i).getLocation().y + BODY_SIZE)) {
                    end = true;
                    finalEnd = true;
                    break;
                }
            ...
            if (direction == 0 || direction == 3) {
                if ((innerPanel.getLocation().x + BODY_SIZE) > tail.get(i).getLocation().x
                        && innerPanel.getLocation().y > tail.get(i).getLocation().y
                        && (innerPanel.getLocation().x + BODY_SIZE) < (tail.get(i).getLocation().x + BODY_SIZE)
                        && innerPanel.getLocation().y < (tail.get(i).getLocation().y + BODY_SIZE)) {
                    end = true;
                    finalEnd = true;
                    break;
            ...
            if (direction == 1 || direction == 2) {
                if (innerPanel.getLocation().x > tail.get(i).getLocation().x
                        && (innerPanel.getLocation().y + BODY_SIZE) > tail.get(i).getLocation().y
                        && innerPanel.getLocation().x < (tail.get(i).getLocation().x + BODY_SIZE)
                        && (innerPanel.getLocation().y + BODY_SIZE) < (tail.get(i).getLocation().y + BODY_SIZE)) {
                    end = true;
                    finalEnd = true;
                    break;
                }
    ...
    public void spawnApple() {
        ...
        switch (appleType) {
            case 0:
                ...
                break;
            case 1:
                apple.setBackground(appleSpeedColor);
                break;
            case 2:
                apple.setBackground(appleHalfingColor);
                break;
        }
    ...
    public synchronized void appleEaten() {
        ...
        if (apple.getBackground().equals(appleColor)) {
            synchronized (this) {
                ...
                if (innerPanel.getLocation().x >= apple.getLocation().x
                        && innerPanel.getLocation().y >= apple.getLocation().y
                        && innerPanel.getLocation().x <= (apple.getLocation().x + BODY_SIZE)
                        && innerPanel.getLocation().y <= (apple.getLocation().y + BODY_SIZE)
                    ...
                    are.setText(Integer.toString(appleCounter));
                    applethread.start();
                } else if ((innerPanel.getLocation().x + BODY_SIZE) >= apple.getLocation().x
                        && innerPanel.getLocation().y >= apple.getLocation().y
                        && (innerPanel.getLocation().x + BODY_SIZE) <= (apple.getLocation().x + BODY_SIZE)
                        && innerPanel.getLocation().y <= (apple.getLocation().y + BODY_SIZE)
                    ...
                    are.setText(Integer.toString(appleCounter));
                    applethread.start();
                } else if (innerPanel.getLocation().x >= apple.getLocation().x
                        && (innerPanel.getLocation().y + BODY_SIZE) >= apple.getLocation().y
                        && innerPanel.getLocation().x <= (apple.getLocation().x + BODY_SIZE)
                        && (innerPanel.getLocation().y + BODY_SIZE) <= (apple.getLocation().y + BODY_SIZE)
